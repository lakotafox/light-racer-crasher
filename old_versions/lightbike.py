...
class LightBikeGame:
    ...
    def draw_ui(self):
        ...
        self.stdscr.addstr(self.game_height + 2, 2, "Use arrow keys to move | Q to quit | R to restart | M to toggle music")
        music_status = "ON" if self.sound_manager.sound_enabled else "OFF"
        self.stdscr.addstr(self.game_height + 1, self.game_width - 15, f"Music: {music_status}")
    ...
    def draw_title_screen(self):
        ...
        # Menu options
        menu_y = bike_y + len(bike_art) + 3
        self.stdscr.attron(curses.color_pair(6))
        menu_items = [
            "Press SPACE to start",
            "Press Q to quit",
            f"Music: {'ON' if self.sound_manager.sound_enabled else 'OFF'} (press M to toggle)"
        ]
        ...
        self.stdscr.attron(curses.color_pair(3))
        self.stdscr.addstr(self.height - 2, (self.width - len(credit)) // 2, credit)
        self.stdscr.attroff(curses.color_pair(3))
    ...
    def draw_game_over(self):
        ...
        if self.game_over:
            ...
            x = (self.game_width - len(msg)) // 2
            self.stdscr.attron(curses.color_pair(4) | curses.A_BOLD)
            self.stdscr.addstr(y, x, msg)
            self.stdscr.addstr(y + 2, x, "Press R to restart or Q to quit")
